	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Like'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			...
			<?php echo $this->Html->link($like['User']['id'], array('controller' => 'users', 'action' => 'view', $like['User']['id'])); ?>
								...
								<td>
			<?php echo $this->Html->link($like['Message']['id'], array('controller' => 'messages', 'action' => 'view', $like['Message']['id'])); ?>
		</td>
								<td>
			<?php echo $this->Html->link($like['Thread']['title'], array('controller' => 'threads', 'action' => 'view', $like['Thread']['id'])); ?>
		</td>
						<td><?php echo h($like['Like']['created']); ?>&nbsp;</td>
						<td><?php echo h($like['Like']['modified']); ?>&nbsp;</td>
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $like['Like']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $like['Like']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $like['Like']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $like['Like']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
