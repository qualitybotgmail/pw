<div class="attachements index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Attachements'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Attachement'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<?php foreach ($attachements as $attachement): ?>
					<tr>
						<td><?php echo h($attachement['Attachement']['id']); ?>&nbsp;</td>
								<td>
			...
			<?php echo $this->Html->link($attachement['Message']['id'], array('controller' => 'messages', 'action' => 'view', $attachement['Message']['id'])); ?>
						...
						<td><?php echo h($attachement['Attachement']['name']); ?>&nbsp;</td>
						<td><?php echo h($attachement['Attachement']['path']); ?>&nbsp;</td>
						<td><?php echo h($attachement['Attachement']['created']); ?>&nbsp;</td>
						<td><?php echo h($attachement['Attachement']['modified']); ?>&nbsp;</td>
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $attachement['Attachement']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $attachement['Attachement']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $attachement['Attachement']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $attachement['Attachement']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
