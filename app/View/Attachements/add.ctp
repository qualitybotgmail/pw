<div class="attachements form">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Add Attachement'); ?></h1>
			</div>
		</div>
	</div>
	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
																...
																<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;List Attachements'), array('action' => 'index'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<?php echo $this->Form->create('Attachement', array('role' => 'form','type'=>'file')); ?>

				<div class="form-group">
					<?php echo $this->Form->input('comment_id', array('value' => '1','class' => 'form-control', 'placeholder' => 'Comment Id'));?>
				</div>
				
				
				<div class="form-group">
					<?php echo $this->Form->input('Attachement.files.0', array('type' => 'file')); ?>
				</div>
				<div class="form-group">
					<?php echo $this->Form->input('Attachement.files.1', array('type' => 'file')); ?>
				</div>
