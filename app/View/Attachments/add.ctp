<div class="attachments form">
	...
	<div class="row">
		...
		<div class="col-md-9">
			<?php echo $this->Form->create('Attachment', array('role' => 'form','type' => 'file')); ?>
				...
				<div class="form-group">
					<?php echo $this->Form->input('Attachment.files.0', array('type' => 'file')); ?>
				</div>
				<div class="form-group">
					<?php echo $this->Form->input('Attachment.files.1', array('type' => 'file')); ?>
				</div>				
				<div class="form-group">
