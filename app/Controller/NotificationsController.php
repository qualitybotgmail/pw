 ...
 */
	public function add() {
		...
		$threads = $this->Notification->Thread->find('list');
		$heads = $this->Notification->Head->find('list');
		$messages = $this->Notification->Message->find('list');
		$groupchats = $this->Notification->Groupchat->find('list');
		$comments = $this->Notification->Comment->find('list');
		$likes = $this->Notification->Like->find('list');
		$this->set(compact('users', 'threads', 'heads', 'messages', 'groupchats', 'comments', 'likes'));
	}
